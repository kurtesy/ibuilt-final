...
setTimeout(() => {
      ...
      if (plotBreadth >= 60 && plotBreadth <= 64) //d Breadth range = 60-64 
    {
      ...
      if (plotBreadth >= 65 && plotBreadth <= 70) //d Breadth range = 65-78 
     {
      ...
      if (plotBreadth >= 71 && plotBreadth <= 80) //d Breadth range = 65-78 
      {
        //bedroom3
        const bed1Length = builtLength * 0.42
         const bed1Breadth = builtBreadth * 0.28
   ...
   if(plotLength >= 29 && plotLength <= 33) //Breadth :29-33 
     {
        ...
        const livingLength = builtLength * 0.40
  ...
  store.dispatch(
    ...
    store.dispatch(
      updateRoomData({
        ...
        length: extraBathLength,
        breadth: extraBathBreadth,
        position: {left:Math.floor(bed3Length)*scale+setbacks.left*scale, 
          bottom:Math.floor(parkingBreadth+mediaBreadth)*scale-9 }}))          
...
setTimeout(() => {
  ...
  if(plotLength >= 64 && plotLength <= 67) //Breadth :64-67
    {
        ...
        const extraBath1Length = builtLength * 0.10
        const extraBath1Breadth = builtBreadth * 0.40
        const extraSitoutLength = builtLength * 0.08
  ...
  const extraBathLength = builtLength * 0.10
  const extraBathBreadth = builtBreadth * 0.30
  const extraBath1Length = builtLength * 0.10
  const extraBath1Breadth = builtBreadth * 0.30
  const extraSitoutLength = builtLength * 0.2
  const extraSitoutBreadth = builtBreadth * 0.10
  const extraSitout1Length = builtLength * 0.15
  const extraSitout1Breadth = builtBreadth * 0.10
...
setTimeout(() => {
  store.dispatch(
    updateRoomData({
      ...
      length: extraBathLength,
      breadth: extraBathBreadth,
      position: {left:Math.floor(extraSitoutLength)*scale+setbacks.left*scale, 
        ...
        updateRoomData({
          ...
          store.dispatch(
            updateRoomData({
              ...
              length: extraSitoutLength,
              breadth:extraSitoutBreadth,
              position: {left:Math.floor(setbacks.left)*scale, 
                bottom:Math.floor(parkingBreadth)*scale-setbacks.front*scale }})) 
            ...
            updateRoomData({
              ...
              store.dispatch(
                updateRoomData({
                  ...
                  breadth:extraSitoutBreadth,
                  position: {right:0, 
                    bottom:Math.floor(stairCaseBreadth+extraBathBreadth)*scale-setbacks.front*scale }})) 
