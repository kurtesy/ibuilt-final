    ...
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          id: "se",
          roomType: "commonToilet",
          position: { top: Math.floor(bed2Breadth +poojaBreadth) * parseInt(scale)+setbacks.back*scale, left: 0 }
        })
      );
    }, 100);
    ...
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: commonToiletLength,
          breadth: commonToiletBreadth,
          position: { top: Math.floor(bed1Breadth) * parseInt(scale) + setbacks.back * scale + 5, right: 0 }
        })
      );
    }, 100);
...
function generateTypeB(number) {
  ...
  if (plotLength >= 35 && plotLength <= 38) {
    ...
    setTimeout(() => {
      ...
      store.dispatch(updateRoomData({ id: "nw", roomType: "toilet", length: toilet1Length, breadth: toilet1Breadth, position: { top: Math.floor(bed2Breadth - toilet1Breadth) * scale, bottom: 0 } }));
  ...
  if (plotLength >= 65 && plotLength <= 70) {
    ...
    const bed2Length = builtLength * 0.25;
    const bed2Breadth = builtBreadth * 0.46;
    const bed3Length = builtLength * 0.2;
