...
function generateTypeA() {
  ...
  if (plotBreadth >= 18 && plotBreadth <= 22) {
    //Breadth greater than 18-22
  ...
  if (plotBreadth >= 23 && plotBreadth <= 26) {
    //Breadth greater than 23-26
    const bed1Length = builtLength * 0.45
    const bed1Breadth = builtBreadth * 0.5
    const bed2Length = builtLength * 0.7
  ...
  if (plotBreadth >= 27 && plotBreadth <= 31) {
    //Breadth greater than 27-31
  ...
  if (plotBreadth >= 32 && plotBreadth <= 34) {
    //Breadth greater than 32-34
    const bed1Length = builtLength * 0.45
    const bed1Breadth = builtBreadth * 0.5
  ...
  if (plotBreadth >= 35 && plotBreadth <= 40) {
    //Breadth greater than 35-40
  ...
  if (plotBreadth >= 46 && plotBreadth <= 49) {
    //Breadth greater than 46-49
    const bed1Length = builtLength * 0.5
    const bed1Breadth = builtBreadth * 0.4
    const bed2Length = builtLength * 0.5
    const bed2Breadth = builtBreadth * 0.4
  ...
  if (plotBreadth >= 50 && plotBreadth <= 54) {
    //Breadth greater than 50-54
    const bed1Length = builtLength * 0.5
    const bed1Breadth = builtBreadth * 0.4
    const bed2Length = builtLength * 0.5
    const bed2Breadth = builtBreadth * 0.4
    ...
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: commonToiletLength,
          breadth: commonToiletBreadth,
          position: { top: Math.floor(bed1Breadth) * parseInt(scale) + setbacks.back * scale, right: 0 }
        })
      )
    }, 100)
  ...
  if (plotBreadth >= 55 && plotBreadth <= 62) {
    //Breadth greater than 55-62
    const bed1Length = builtLength * 0.5
    ...
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: commonToiletLength,
          breadth: commonToiletBreadth,
          position: { right: 0, top: Math.floor(bed1Breadth + extraSitoutBreadth) * scale - 14 }
        })
      )
    }, 100)
  ...
  if (plotBreadth >= 68 && plotBreadth <= 73) {
    //Breadth greater than 68-73
    const bed1Length = builtLength * 0.42
    const bed1Breadth = builtBreadth * 0.31
    ...
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          id: '',
          roomType: 'pooja',
          position: { top: Math.floor(bed1Breadth - poojaBreadth) * parseInt(scale) + 0, right: Math.floor(extraSitoutLength) * scale - 15 }
        })
      )
    ...
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: commonToiletLength,
          breadth: commonToiletBreadth,
          position: { top: Math.floor(bed1Breadth + bed4Breadth + extraSitoutBreadth) * parseInt(scale) - setbacks.back * scale - 18, right: 0 }
        })
      )
    }, 100)
  ...
  if (plotBreadth >= 74 && plotBreadth <= 81) {
    //Breadth greater than 74-81
    const bed1Length = builtLength * 0.45
    const bed1Breadth = builtBreadth * 0.31
    ...
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          id: 'ne',
          roomType: 'pooja',
          position: { top: Math.floor(bed2Breadth + mediaBreadth) * parseInt(scale) + 3, left: Math.floor(extraBathLength) * scale - 18 }
        })
      )
    ...
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: commonToiletLength,
          breadth: commonToiletBreadth,
          position: { top: 0, right: Math.floor(setbacks.right) * scale + 6 }
        })
      )
    }, 100)
...
function generateTypeB(number) {
  ...
  if (plotLength >= 35 && plotLength <= 38) {
    ...
    const sitoutBreadth = builtBreadth * 0.3
    const mediaLength = builtLength * 0.1
    const mediaBreadth = builtBreadth * 0.0
    ...
    setTimeout(() => {
      ...
      store.dispatch(updateRoomData({ id: 'nw', roomType: 'toilet', length: toilet1Length, breadth: toilet1Breadth, position: { top: Math.floor(toilet3Breadth) * scale, bottom: 0 } }))
      // store.dispatch(updateRoomData({ id: 'ne', roomType: 'toilet', length: toilet2Length, breadth: toilet2Breadth,}))
      // position: { left: Math.floor(bed1Length-setbacks.left) *scale, top:0 }}))
      // store.dispatch(updateRoomData({ id: 'se', roomType: 'toilet', length: toilet3Length, breadth: toilet3Breadth,
      // position: { bottom:0, left:0 }}))
    ...
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: sitoutLength,
          breadth: sitoutBreadth,
          position: { right: Math.floor(bed3Length + mediaLength) * scale + setbacks.right * scale, top: 0 }
        })
      )
      ...
      store.dispatch(
        updateRoomData({
          ...
          breadth: mediaBreadth,
          // position: { left: 0, top:0 }
          position: { top: 0, right: Math.floor(bed3Length) * scale + 18 }
        })
      )
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: diningLength,
          breadth: diningBreadth,
          position: { bottom: 0, right: Math.floor(kitchenBreadth) * scale }
        })
      )
    }, 100)
    //Add walls
  ...
  if (plotLength >= 50 && plotLength <= 54) {
    ...
    const livingLength = builtLength * 0.35
    const livingBreadth = builtBreadth * 0.5
    const drawingLength = builtLength * 0.22
    const drawingBreadth = builtBreadth * 0.5
    ...
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: mediaLength,
          breadth: mediaBreadth,
          position: { right: Math.floor(bed1Length) * (scale + 1), top: 0 }
        })
      )
  ...
  if (plotLength >= 55 && plotLength <= 59) {
    ...
    setTimeout(() => {
      ...
      store.dispatch(updateRoomData({ id: 'se', roomType: 'toilet', length: toilet3Length, breadth: toilet3Breadth, position: { bottom: 0, left: 0 } }))
      store.dispatch(updateRoomData({ id: 'sw', roomType: 'toilet', length: toilet1Length, breadth: toilet1Breadth, position: { bottom: 0, left: 0 } }))
  ...
  if (plotBreadth <= 35 && plotBreadth >= 25) {
  ...
  if (plotLength >= 60 && plotLength <= 64) {
    //Breadth :60-70
  ...
  if (plotLength >= 65 && plotLength <= 70) {
    //Breadth :65-70
    const bed1Length = builtLength * 0.25
    const bed1Breadth = builtBreadth * 0.455
    const bed2Length = builtLength * 0.25
    const bed2Breadth = builtBreadth * 0.46
    const bed3Length = builtLength * 0.25
    const bed3Breadth = builtBreadth * 0.5
    ...
    const toilet3Length = builtLength * 0.06
    ...
    setTimeout(() => {
      store.dispatch(
        updateRoomData({
          ...
          length: bed1Length,
          breadth: bed1Breadth,
          position: { left: 0, bottom: Math.floor(stairCaseBreadth) * scale - setbacks.front * scale + 18 }
        })
      )
      store.dispatch(
        updateRoomData({
    ...
    setTimeout(() => {
      store.dispatch(
        updateRoomData({
          ...
          length: drawingLength,
          breadth: drawingBreadth,
          position: { top: 0, right: Math.floor(bed3Length) * scale + 9 }
        })
      )
      store.dispatch(
        updateRoomData({
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: poojaLength,
          breadth: poojaBreadth,
          position: { right: Math.floor(bed3Length) * scale + 6, top: 0 }
        })
      )
    }, 100)
    setTimeout(() => {
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: sitoutLength,
          breadth: sitoutBreadth,
          position: { right: Math.floor(bed3Length + poojaLength) * scale + setbacks.right * scale + 11, top: 0 }
        })
      )
      ...
      store.dispatch(
        updateRoomData({
          ...
          length: mediaLength,
          breadth: mediaBreadth,
          position: { bottom: 0, left: Math.floor(bed1Length) * scale + 10 }
        })
      )
