...
function generateTypeA() {
  ...
  if (plotBreadth >= 20 && plotBreadth < 40) {
    //Breadth greater than 20-40
  ...
  if (plotBreadth >= 40 && plotBreadth < 50) {
    //Breadth greater than 40-50
  ...
  if (plotBreadth >= 50 && plotBreadth < 95) {
    //Breadth greater than 50-65
    const bed1Length = builtLength * 0.5
...
function generateTypeB(number) {
  ...
  if (plotLength >= 16 && plotLength < 30) {
    ...
    const toilet2Length = builtLength * 0.1
