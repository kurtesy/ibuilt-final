      ...
      <section className='w-full h-full bg-[#090827]'>
        <div className='w-full h-full flex items-center justify-around px-6 gap-3'>
          <div className='flex items-start px-24 flex-col gap-4  w-1/2'>
            ...
            <div className='text-lg text-slate-200'>iBuiltup is committed to empower you with simplified technical skills, therefore carve out your dream home project by yourself.</div>
            <Link
              to='/drawing'
          ...
          <div className='w-1/2 flex items-center justify-center font-thin bg-slate-200 h-[600px]'>YOUR VIDEO</div>
        </div>
      </section>
    </div>
  );
