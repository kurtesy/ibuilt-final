    ...
    <div className='w-full h-full'>
      ...
      <div className='w-120px h-[calc(100%-60px)] flex items-center justify-center'>
        ...
        <div className='w-1/3 flex items-center flex-col justify-center gap-6'>
          <div className='text-3xl font-semibold text-slate-800'>Welcome back</div>
          ...
          <div className='text-md font-thin'>
            ...
            <Link className='text-primaryLime font-blod px-2 cursor-pointer h-full z-50' to='/auth/signup'>
              Signup
            </Link>
          </div>
